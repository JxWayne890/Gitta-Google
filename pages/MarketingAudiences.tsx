       ...
       <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
           <table className="w-full text-left border-collapse">
               ...
               <tbody className="divide-y divide-slate-50 dark:divide-slate-700">
                   {segments.map(seg => (
                       <tr key={seg.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-700/30 transition-colors">
                           ...
                           <td className="px-6 py-4">
                               <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase border ${seg.type === 'DYNAMIC' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800' : 'bg-slate-50 dark:bg-slate-700/50 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-600'}`}>
                                   {seg.type}
                               </span>
                           </td>
                           ...
                           <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-300">
                               {seg.criteria ? (
                                   ...
                                   <span className="text-slate-400 dark:text-slate-500 italic">All Contacts</span>
                               )}
                           </td>
                           ...
                           <td className="px-6 py-4 text-right">
                               <button className="p-2 text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">
